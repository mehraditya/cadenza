"""RGB camera analyzer for the G1 forward camera.

Same HSV beacon detector as the Go1 variant. Reports vivid-color region
bearing/size into the world model so the VLA can navigate by color cues.
"""
...
class RGB(Modality):
    """HSV-based vivid-color beacon detector for the G1 forward camera."""

    name = "g1_rgb"
    description = "Numpy HSV beacon detector for G1 forward camera."
